...
public class ProductCompositeIntegration implements ProductService, RecommendationService, ReviewService {
    ...
    public ProductCompositeIntegration(RestTemplate restTemplate, ObjectMapper mapper,
        ...
        productServiceUrl = HTTP_PROTOCOL + productServiceHost + ":" + productServicePort + "/product/";

        recommendationServiceUrl = HTTP_PROTOCOL + recommendationServiceHost + ":" + recommendationServicePort
                + "/recommendation?productId=";

        reviewServiceUrl = HTTP_PROTOCOL + reviewServiceHost + ":" + reviewServicePort + "/review?productId=";
